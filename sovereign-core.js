/* 🛡️ VITRIN III - SISTEMA SOBERANO ATIVADO */
(function() {
    window.Soberano = {
                ...
                container.innerHTML = `
                    <div style="padding:15px; text-align:left;">
                        ...
                        <div style="background:#fff; border-radius:20px; padding:20px; margin-bottom:15px; border-left:6px solid #00ff00; box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                            ...
                            <h3 style="margin:10px 0; font-size:20px;">${temDados ? "BBB26: Nova Prova" : "Carregando Tendências..."}</h3>
    ...
    window.onload = () => { if(window.Soberano) Soberano.cura(); };
})();
